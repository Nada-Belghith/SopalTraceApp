      ...
      <div v-for="mod in modelesFiltres" :key="mod.id"
        ...
        <div class="p-3 bg-slate-50 border-t border-slate-100 flex gap-3">
          <template v-if="mod.statut !== 'ARCHIVE'">
            ...
            <button class="flex-1 bg-emerald-100 text-emerald-700 py-2 rounded-lg font-bold text-xs flex items-center justify-center gap-2 hover:bg-emerald-200 transition-colors">
